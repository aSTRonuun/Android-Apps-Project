package com.astronuun.motivation.data
...
class Mock {
    ...
    fun getPhrase(categoryId: Int, lang: String): String {
        ...
        val filtered =
            listPhrases.filter { (it.categoryId == categoryId || categoryId == 1) && it.language == lang }

        return filtered[(filtered.indices).random()].description
    }
}